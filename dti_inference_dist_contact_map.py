...
def main(rank, world_size, args, dataset, dist_dict, seed=0):
    ...
    # max_epoch = 1300
    max_epoch = max([p for p in prefixes if p <= 850])
...
if __name__ == '__main__':
    ...
    # distances_path = "/local2/rakesh/DiffDock/results/alphafold_davis2_test/"

    distances_path = "data/pconsc4/"
    ...
    def extract_protein_contact_map(opts, contact_path):
        ...
        # with open('data/davis_pconsc4_dist.pickle', 'wb') as handle:
        #     pickle.dump(all_distances, handle, protocol=pickle.HIGHEST_PROTOCOL)
        return all_distances

    # Load the train distances
    # all_distances = pickle.load(open('data/davis_pconsc4_dist.pickle', 'rb'))
